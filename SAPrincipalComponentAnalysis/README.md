...
## [<img src="https://github.com/QuantLet/Styleguide-and-FAQ/blob/master/pictures/qloqo.png" alt="Visit QuantNet">](http://quantlet.de/) **SAPrincipalComponentAnalysis** [<img src="https://github.com/QuantLet/Styleguide-and-FAQ/blob/master/pictures/QN2.png" width="60" alt="Visit QuantNet 2.0">](http://quantlet.de/)
...
Description : 'Computes Principal Component Analysis on KNHANES Nutrition Survey dataset aiming to
derive key dietary patterns based on 23 food groups'

Keywords : 'South Korea, nutrition survey, KNHANES, food groups, nutrition, principal component
analysis, PCA, dietary patterns, scree plot'
...
![Picture1](PlotScree1998.png)

![Picture2](PlotScree2015.png)
